...
function Product(name) {
  this.name = name;
  // this.path = `img/` + name + `.jpg`; ====== add ${} around variables in concantenations=====
...
function displayPics(){
  ...
  // `rando` is defined in the displayPics function and let causes the definition to be local to the function.
  console.log(viewed);
